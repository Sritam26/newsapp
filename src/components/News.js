...
export default class News extends Component {
 ...
 async componentDidMount(){
    let url="https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=c4a96d93ddba478182dd28222fb207a2&page=1&pagesize=10"
 ...
 nextclick=async()=>{
  ...
  let url=`https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=c4a96d93ddba478182dd28222fb207a2&page=${this.state.page+1}&pagesize=10`
    let data=await fetch(url)
    let parsedata=await data.json()
    console.log(parsedata)
  this.setState({
